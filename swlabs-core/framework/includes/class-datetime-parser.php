 ...
 * @since 1.0
 */
class SwlabsCore_DateTime_Parser {
	/**
	...
	public static function parse( $value, $pattern = 'MM/dd/yyyy' , $defaults = array() ) {
		...
		if(SwlabsCore_Timestamp::is_valid_date( $year, $month, $day ) && SwlabsCore_Timestamp::is_valid_time( $hour, $minute, $second ) ) {
			return SwlabsCore_Timestamp::get_timestamp( $hour, $minute, $second, $month, $day, $year );
		} else {
			return false;
		}
	}
