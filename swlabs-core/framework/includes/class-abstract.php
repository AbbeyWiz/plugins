...
class SwlabsCore_Abstract {
	...
	public function save() {
		...
		foreach( func_get_args() as $field ) {
			$new = SwlabsCore::get_request_param( $field, NULL );
		...
		$output .= '<div class="box-upload">';
			...
			$output .= '<div class="upload">';
				$output .= '<div class="upload-video">';
					$output .= '<div><input name="'.$name.'" class="textbox-url-video" type="text" value="'.$value.'" /></div>';
					$output .= '<div class="button-upload"><input class="shw_upload_button" type="button" value="Browse" /></div>';
				$output .= '</div>';
			$output .= '</div>';
		$output .= '</div>';
