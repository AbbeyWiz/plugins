...
SwlabsCore::load_class( 'DateTime_Parser' );

class SwlabsCore_Validator {
	/**
	...
	public static $built_in_validators = array(
		'required' => 'SwlabsCore_Validator_Required',
		'filter'   => 'SwlabsCore_Validator_Filter',
		'match'    => 'SwlabsCore_Validator_Regular_Expression',
		'email'    => 'SwlabsCore_Validator_Email',
		'url'      => 'SwlabsCore_Validator_Url',
		'compare'  => 'SwlabsCore_Validator_Compare',
		'length'   => 'SwlabsCore_Validator_String',
		'in'       => 'SwlabsCore_Validator_Range',
		'numerical'=> 'SwlabsCore_Validator_Number',
		'default'  => 'SwlabsCore_Validator_Default_Value',
		'boolean'  => 'SwlabsCore_Validator_Boolean',
		'date'     => 'SwlabsCore_Validator_Date',
		'type'     => 'SwlabsCore_Validator_Type'
	);
	...
	public static function create_validator( $name, $object, $attributes, $params = array() ) {
		...
		if( method_exists( $object, $name ) ) {
			$validator = new SwlabsCore_Validator_Inline;
 ...
 * @since 1.0
 */ 
class SwlabsCore_Validator_Date extends SwlabsCore_Validator {
	/**
	...
	protected function validate_attribute( $object, $attribute ) {
		...
		foreach( $formats as $format ) {
			$timestamp = SwlabsCore_DateTime_Parser::parse( $value, $format, array( 'month' => 1, 'day' => 1, 'hour' => 0, 'minute' => 0, 'second' => 0 ) );
			if( $timestamp !== false ) {
				$valid = true;
 ...
 * @since 1.0
 */
class SwlabsCore_Validator_Type extends SwlabsCore_Validator {
	/**
	...
	public function validate_value( $value ) {
		...
		if( $type === 'integer' ) {
			...
			return SwlabsCore_DateTime_Parser::parse( $value, $this->date_format, array( 'month' => 1, 'day' => 1, 'hour' => 0, 'minute' => 0, 'second' => 0 ) ) !== false;
		} elseif( $type === 'time' ) {
			return SwlabsCore_DateTime_Parser::parse( $value, $this->time_format ) !== false;
		} elseif( $type === 'datetime' ) {
			return SwlabsCore_DateTime_Parser::parse( $value, $this->datetime_format, array( 'month' => 1, 'day' => 1, 'hour' => 0, 'minute' => 0, 'second' => 0 ) ) !== false;
		}
 ...
 * @since 1.0
 */ 
class SwlabsCore_Validator_Inline extends SwlabsCore_Validator {
	/**
 ...
 * @since 1.0
 */ 
class SwlabsCore_Validator_Boolean extends SwlabsCore_Validator {
	/**
 ...
 * @since 1.0
 */
class SwlabsCore_Validator_Compare extends SwlabsCore_Validator {
	/**
 ...
 * @since 1.0
 */
class SwlabsCore_Validator_Email extends SwlabsCore_Validator {
	/**
 ...
 * @since 1.0
 */
class SwlabsCore_Validator_Default_Value extends SwlabsCore_Validator {
	/**
 ...
 * @since 1.0
 */
class SwlabsCore_Validator_Filter extends SwlabsCore_Validator {
	/**
 ...
 * @since 1.0
 */
class SwlabsCore_Validator_Number extends SwlabsCore_Validator {
	/**
 ...
 * @since 1.0
 */
class SwlabsCore_Validator_Range extends SwlabsCore_Validator {
	/**
 ...
 * @since 1.0
 */
class SwlabsCore_Validator_Regular_Expression extends SwlabsCore_Validator {
	/**
 ...
 * @since 1.0
 */
class SwlabsCore_Validator_Required extends SwlabsCore_Validator {
	/**
 ...
 * @since 1.0
 */
class SwlabsCore_Validator_String extends SwlabsCore_Validator {
	/**
 ...
 * @since 1.0
 */
class SwlabsCore_Validator_Url extends SwlabsCore_Validator {
	/**
	 * @var string the regular expression used to validate the attribute value.
