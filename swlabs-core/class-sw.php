...
class SwlabsCore {
	...
	public static function load_class( $class , $module = null ) {
		...
		return class_exists( 'SwlabsCore_' . $class );
	}
	...
	public static function get_config( $name, $field = NULL ) {
		...
		if( false == $setting ) {
			if( file_exists( SWLABSCORE_DIR . '/framework/config.php' ) ) {
				$setting = require( SWLABSCORE_DIR . '/framework/config.php' );
			}
		}
	...
	public static function get_params( $name, $field = NULL ) {
		static $params = false;
		if( false == $params ) {
			if( file_exists( SWLABSCORE_DIR . '/framework/params.php' ) ) {
				$params = require( SWLABSCORE_DIR . '/framework/params.php' );
			}
		}
