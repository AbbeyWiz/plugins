...
$column = SwlabsCore::get_params('block_carousel_column');
$style = array(
	'Default' => '',
	'Style 2' => '2'
);
...
vc_map(array(
		'name'        => esc_html__( 'SW Slider 1', 'swlabs-core' ),
		'base'        => 'swlabscore_block_slider_sc_1',
		'class'       => 'swlabs-core-sc',
		'icon'        => 'icon-swlabscore_block_slider_sc_1',
		'category'    => SWLABSCORE_SC_CATEGORY,
		'description' => esc_html__( 'Slider with WP Posts.', 'swlabs-core' ),
		'params'      => $params
	)
);