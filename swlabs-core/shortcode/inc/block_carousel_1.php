...
$block_carousel_column = SwlabsCore::get_params('block_carousel_column');
...
$params = array(
	...
	array(
		...
		'param_name'  => 'column',
		'value'       => $block_carousel_column,
		'description' => esc_html__( 'Choose column to show in page.Default is one column.', 'swlabs-core' )
	),
	array(
		'type'        => 'dropdown',
...
vc_map(array(
		'name'        => esc_html__( 'SW Carousel 1', 'swlabs-core' ),
		'base'        => 'swlabscore_block_carousel_sc_1',
		'class'       => 'swlabs-core-sc',
		'icon'        => 'icon-swlabscore_block_carousel_sc_1',
