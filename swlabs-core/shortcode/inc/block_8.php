...
$params = array(
	...
	array(
		...
		'param_name'  => 'showexceprt',
		'value'       => $showexceprt,
		'description' => esc_html__( 'Choose if appear exerpt or not.', 'swlabs-core' )
	),
	array(
		'type'        => 'textfield',
...
vc_map(array(
		'name'        => esc_html__( 'SW Block 8', 'swlabs-core' ),
		'base'        => 'swlabscore_block_sc_8',
		'class'       => 'swlabs-core-sc',
		'icon'        => 'icon-swlabscore_block_sc_8',
