...
vc_map(array(
		'name'        => esc_html__( 'SW Video List', 'swlabs-core' ),
		'base'        => 'swlabscore_video_list_sc',
		'class'       => 'swlabs-core-sc',
		'icon'        => 'icon-swlabscore_video_list_sc',
		'category'    => SWLABSCORE_SC_CATEGORY,
		'description' => esc_html__( 'List of video format type', 'swlabs-core' ),
		'params'      => $params
	)
);
