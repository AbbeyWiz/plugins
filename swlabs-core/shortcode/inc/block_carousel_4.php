...
$yes_no = SwlabsCore::get_params('yes_no');
$params = array(
	array(
		'type'        => 'textfield',
	...
	array(
		...
		'value'       => $yes_no,
		'description' => esc_html__( 'Check in this if you want to show excerpt.', 'swlabs-core' )
	),
	array(
		'type'        => 'dropdown',
		'heading'     => esc_html__( 'Show Meta', 'swlabs-core' ),
		'param_name'  => 'show_meta',
		'value'       => $yes_no,
		'description' => esc_html__( 'Check in this if you want to show meta infomation of post.', 'swlabs-core' )
	),
	array(
		'type'        => 'textfield',
...
vc_map(array(
		'name'        => esc_html__( 'SW Carousel 4', 'swlabs-core' ),
		'base'        => 'swlabscore_block_carousel_sc_4',
		'class'       => 'swlabs-core-sc',
		'icon'        => 'icon-swlabscore_block_carousel_sc_4',
