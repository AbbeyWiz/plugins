...
$block_13_column = SwlabsCore::get_params('block_column');
...
$params = array(
	...
	array(
		...
		'param_name'  => 'column',
		'value'       => $block_13_column,
		'description' => esc_html__( 'Choose column.Default is four column.', 'swlabs-core' )
	),
	array(
		'type'        => 'dropdown',
...
vc_map(array(
		'name'        => esc_html__( 'SW Block 11', 'swlabs-core' ),
		'base'        => 'swlabscore_block_sc_11',
		'class'       => 'swlabs-core-sc',
		'icon'        => 'icon-swlabscore_block_sc_11',
